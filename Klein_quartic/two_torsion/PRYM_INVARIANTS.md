...
| # | `(j₁, j₂, j₃)` | mult | complexes |
|---|---|---|---|
| 1 | `(2048, −192, 64)` | 28 | 3, 4, 7, 9, 10, 13, 18, 20, 24, 25, 26, 27, 29, 34, 35, 37, 38, 39, 40, 45, 48, 49, 51, 52, 53, 57, 59, 63 |
| 2 | `(2048/343, 4416/343, −2816/343)` | 21 | 1, 2, 5, 8, 11, 15, 17, 21, 22, 28, 30, 32, 43, 46, 47, 55, 56, 58, 60, 61, 62 |
| 3 | `(1/343)·(−76740102 w − 95211256, −3674430 w − 3245592, 39906 w − 728)` | 7 | 6, 16, 19, 23, 33, 41, 42 |
| 4 | `(1/343)·(76740102 w + 96638999, 3674430 w + 5940483, −39906 w − 100493)` | 7 | 12, 14, 31, 36, 44, 50, 54 |
...
| # | `(j₁, j₂, j₃)` | mult | complexes |
|---|---|---|---|
| 1 | `(50000, 3750, −125)` | **1** | 34 |
| 2 | `(8388608, 245760, 4096)` | 6 | 3, 4, 38, 40, 62, 63 |
| 3 | `(131072, 6144, −512)` | 24 | 5, 6, 9, 10, 13, 14, 15, 16, 21, 22, 25, 26, 29, 30, 39, 41, 44, 45, 47, 49, 50, 51, 60, 61 |
| 4 | `(224208(w³−w) + 344408, 7830(w³−w) + 11121, ½(−378(w³−w) − 7))` | 16 | 2, 8, 12, 17, 19, 24, 27, 31, 33, 37, 42, 46, 53, 54, 56, 57 |
| 5 | `(−224208(w³−w) + 344408, −7830(w³−w) + 11121, ½(378(w³−w) − 7))` | 16 | 1, 7, 11, 18, 20, 23, 28, 32, 35, 36, 43, 48, 52, 55, 58, 59 |
...
| # | `(j₁, j₂, j₃)` | mult | complexes |
|---|---|---|---|
| 1 | `(800000000/81, 23560000/81, 40000/9)` | 12 | 3, 4, 17, 34, 37, 38, 41, 44, 45, 55, 56, 61 |
| 2 | `(31172342123300864/5955980625, 804859942779712/5955980625, 68168000576/73530625)` | 12 | 8, 10, 15, 25, 27, 28, 29, 36, 46, 47, 48, 51 |
| 3 | `(1729733224448/151875, 1496258752/5625, −1425053696/4100625)` | 12 | 1, 2, 6, 9, 14, 26, 30, 31, 32, 42, 50, 57 |
| 4 | `(1429519218944000/28588707, 43597764450880/28588707, 33694083654400/771895089)` | 6 | 18, 19, 22, 53, 54, 62 |
| 5 | `(68934134667875/28588707, 1519104335495/28588707, −316737676475/771895089)` | 6 | 11, 21, 24, 35, 58, 63 |
| 6 | `(443801324800000/85766121, 281630680000/3176523, −186184000/352947)` | 4 | 16, 43, 49, 59 |
| 7 | `(6400000/3, 440000/9, −32000/81)` | 4 | 5, 7, 13, 33 |
| 8 | `(607660606990336/220591875, 43805907748544/661775625, −3387870464/9529569)` | 3 | 23, 39, 52 |
| 9 | `(729486255135700992/1838265625, 2177158706811833536/148899515625, 448159706914816/771895089)` | 3 | 12, 20, 40 |
| 10 | `(328783729403804707/5514796875, 301399492750133/661775625, −281175372827/238239225)` | **1** | **60** |
...
and `results/aut_j2_modules.log`.
