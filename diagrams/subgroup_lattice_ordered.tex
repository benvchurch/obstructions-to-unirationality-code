...
%%
\node (1) at (334.5bp,18.0bp) [draw,draw=none] {$1$};
  \node (2) at (292.5bp,148.0bp) [draw,draw=none] {${}_{\textcolor{gray}{91}} 2$};
  \node (3) at (376.5bp,148.0bp) [draw,draw=none] {${}_{\textcolor{gray}{91}} 3$};
  \node (4) at (122.5bp,148.0bp) [draw,draw=none] {${}_{\textcolor{gray}{78}} 4$};
  \node (5) at (498.5bp,148.0bp) [draw,draw=none] {${}_{\textcolor{gray}{14}} 5$};
  \node (6) at (208.5bp,278.0bp) [draw,draw=none] {${}_{\textcolor{gray}{91}} 6$};
  \node (7) at (124.5bp,278.0bp) [draw,draw=none] {${}_{\textcolor{gray}{91}} 7$};
  \node (8) at (376.5bp,278.0bp) [draw,draw=none] {${}_{\textcolor{gray}{91}} 8$};
  \node (9) at (292.5bp,278.0bp) [draw,draw=none] {${}_{\textcolor{gray}{91}} 9$};
  \node (10) at (36.5bp,278.0bp) [draw,draw=none] {${}_{\textcolor{gray}{78}} 10$};
  \node (11) at (498.5bp,278.0bp) [draw,draw=none] {${}_{\textcolor{gray}{14}} 11$};
  \node (12) at (582.5bp,278.0bp) [draw,draw=none] {${}_{\textcolor{gray}{14}} 12$};
  \node (14) at (292.5bp,408.0bp) [draw,draw=none] {${}_{\textcolor{gray}{91}} 14$};
  \node (13) at (208.5bp,408.0bp) [draw,draw=none] {${}_{\textcolor{gray}{91}} 13$};
  \node (15) at (437.5bp,408.0bp) [draw,draw=none] {${}_{\textcolor{gray}{14}} 15$};
  \node (16) at (250.5bp,538.0bp) [draw,draw=none] {$16$};
