...
%%
\node (1) at (334.5bp,18.0bp) [draw,draw=none] {L01END};
  \node (2) at (292.5bp,148.0bp) [draw,draw=none] {L02END};
  \node (3) at (376.5bp,148.0bp) [draw,draw=none] {L03END};
  \node (4) at (122.5bp,148.0bp) [draw,draw=none] {L04END};
  \node (5) at (498.5bp,148.0bp) [draw,draw=none] {L05END};
  \node (6) at (208.5bp,278.0bp) [draw,draw=none] {L06END};
  \node (7) at (124.5bp,278.0bp) [draw,draw=none] {L07END};
  \node (8) at (376.5bp,278.0bp) [draw,draw=none] {L08END};
  \node (9) at (292.5bp,278.0bp) [draw,draw=none] {L09END};
  \node (10) at (36.5bp,278.0bp) [draw,draw=none] {L010END};
  \node (11) at (498.5bp,278.0bp) [draw,draw=none] {L11END};
  \node (12) at (582.5bp,278.0bp) [draw,draw=none] {L12END};
  \node (14) at (292.5bp,408.0bp) [draw,draw=none] {L14END};
  \node (13) at (208.5bp,408.0bp) [draw,draw=none] {L13END};
  \node (15) at (437.5bp,408.0bp) [draw,draw=none] {L15END};
  \node (16) at (250.5bp,538.0bp) [draw,draw=none] {L16END};
