 ...
 * twist_decomps.m
 *
 * Quadric decomposition analysis for x^4+y^4+z^4 and its twist x^4+y^4-z^4.
 *
 * Merged from: twist_decomp_search.m, twist_bitangent_decomp.m
 *
 * Contents:
 *   Part 1: Why l3^2*l1*l2 - Q2^2 = lambda*F CANNOT work for F=x^4+y^4+z^4
 *   Part 2: Quadric decompositions of x^4+y^4-z^4 over Q
 *   Part 3: Q(sqrt(2))-factorization of x^4+y^4+z^4
 *   Part 4: ALL rational bitangent lines of x^4+y^4-z^4
 *   Part 5: Bitangent pair decomposition search for x^4+y^4-z^4
 *   Part 6: General decomps - do any Q1,Q3 factor?
 *   Part 7: Structure analysis of degenerate decompositions
 ******************************************************************************/

R<x,y,z> := PolynomialRing(Rationals(), 3);

// =========== PART 1: POSITIVE-DEFINITENESS OBSTRUCTION FOR x^4+y^4+z^4 ===========
...
// General Q1*Q3 - Q2^2 = F2 search (not restricted to bitangent form)
...
// Reset to Q for the remaining parts
...
// Also check lines ax+y+cz
printf "\nSearching lines ax+y+cz:\n";
for a in [-bnd..bnd] do
for c in [-bnd..bnd] do
...
// =========== PART 5: BITANGENT PAIR DECOMPOSITION SEARCH ===========
printf "=== PART 5: BITANGENT PAIR DECOMPOSITION SEARCH ===\n\n";
...
// =========== PART 6: GENERAL DECOMPS - DO ANY Q1,Q3 FACTOR? ===========
printf "=== PART 6: GENERAL DECOMPS - DO ANY Q1,Q3 FACTOR? ===\n\n";
...
// =========== PART 7: DEGENERATE DECOMPOSITION STRUCTURE ===========
printf "=== PART 7: DEGENERATE DECOMPOSITION STRUCTURE ===\n\n";

// x^4+y^4-z^4 structure analysis
printf "--- Structure of x^4+y^4-z^4 ---\n\n";

// Check specific decompositions for degenerate Q1 or Q3
// From decomp #1: Q3 = x^2+xy-xz+y^2-yz
...
// Check all first decomps for degenerate Q1 or Q3
